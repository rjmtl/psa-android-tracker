...
import com.psaanalytics.core.tracker.TrackerConfigurationInterface
import com.psaanalytics.core.tracker.TrackerDefaults
...
import com.psaanalytics.psa.tracker.PlatformContextRetriever
...
open class TrackerConfiguration : TrackerConfigurationInterface, Configuration {
    ...
    /**
     * Whether the [DeepLink](com.psaanalytics.psa.entity.DeepLink) context entity
