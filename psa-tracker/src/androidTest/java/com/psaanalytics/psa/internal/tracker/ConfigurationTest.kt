...
import com.psaanalytics.core.emitter.Executor.shutdown
...
import com.psaanalytics.psa.tracker.BuildConfig
import com.psaanalytics.psa.tracker.MockEventStore
import com.psaanalytics.psa.tracker.MockNetworkConnection
import com.psaanalytics.psa.tracker.SessionState
import com.psaanalytics.psa.util.Basis
import com.psaanalytics.psa.util.Size
...
class ConfigurationTest {
    ...
    fun sessionConfigurationCallback() {
        ...
        val sharedPreferences = context.getSharedPreferences(
            TrackerConstants.PSA_SESSION_VARS + "_namespace",
    ...
    public void emitterConfiguration() throws InterruptedException {
        ...
        EmitterConfiguration emitterConfiguration = new EmitterConfiguration()
                ...
                .byteLimitGet(10000)
                .emitRange(10);
        TrackerController tracker = Psa.createTracker(context, "namespace", networkConfiguration, trackerConfiguration, emitterConfiguration);
