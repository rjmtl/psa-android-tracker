 ...
 */
package com.psaanalytics.core.session
...
import com.psaanalytics.psa.entity.ClientSessionEntity
import com.psaanalytics.psa.payload.SelfDescribingJson
import com.psaanalytics.psa.tracker.SessionState
import com.psaanalytics.psa.tracker.SessionState.Companion.build
...
class Session @SuppressLint("ApplySharedPref") constructor(
    ...
    init {
        ...
        var sessionVarsName = TrackerConstants.PSA_SESSION_VARS
        if (namespace != null && namespace.isNotEmpty()) {
            val sessionVarsSuffix = namespace.replace("[^a-zA-Z0-9_]+".toRegex(), "-")
            sessionVarsName = TrackerConstants.PSA_SESSION_VARS + "_" + sessionVarsSuffix
        }
    ...
    companion object {
        ...
        private fun retrieveUserId(context: Context, state: SessionState?): String {
            ...
            val generalPref = context.getSharedPreferences(
                TrackerConstants.PSA_GENERAL_VARS,
