...
class MainActivity : Activity() {
    ...
    private val psaDocsUrl = "https://docs.snowplow.io/docs/collecting-data/collecting-from-own-applications/mobile-trackers"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val linkText2 = "- <a href='$psaDocsUrl'>Documentation</a>"
