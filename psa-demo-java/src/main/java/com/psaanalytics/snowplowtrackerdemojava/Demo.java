...
package com.psaanalytics.snowplowtrackerdemojava;
...
import com.psaanalytics.psa.configuration.GdprConfiguration;
import com.psaanalytics.psa.configuration.GlobalContextsConfiguration;
...
import com.psaanalytics.psa.configuration.RemoteConfiguration;
import com.psaanalytics.psa.configuration.SessionConfiguration;
import com.psaanalytics.psa.configuration.TrackerConfiguration;
import com.psaanalytics.psa.controller.EmitterController;
import com.psaanalytics.psa.controller.SessionController;
...
import com.psaanalytics.psa.globalcontexts.GlobalContext;
import com.psaanalytics.psa.tracker.DevicePlatform;
import com.psaanalytics.psa.tracker.LoggerDelegate;
import com.psaanalytics.psa.network.HttpMethod;
import com.psaanalytics.psa.network.RequestCallback;
...
import com.psaanalytics.psa.util.Basis;
import com.psaanalytics.psa.util.TimeMeasure;
import com.psaanalytics.psademocompose.R;
import com.psaanalytics.snowplowtrackerdemojava.utils.DemoUtils;
import com.psaanalytics.snowplowtrackerdemojava.utils.TrackerEvents;
...
import static com.psaanalytics.core.utils.Util.addToMap;
...
public class Demo extends Activity implements LoggerDelegate {
    ...
    protected void onResume() {
        super.onResume();
        TrackerController tracker = Psa.getDefaultTracker();
    ...
    private void setupTabListener() {
        _tabButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TrackerController trackerController = Psa.getDefaultTracker();
    ...
    private boolean setupWithRemoteConfig(@NonNull Consumer<Boolean> callbackTrackerReady) {
        ...
        Psa.setup(getApplicationContext(), remoteConfig, null, configurationPair -> {
            List<String> namespaces = configurationPair.first;

            Objects.requireNonNull(Psa.getDefaultTracker()).getEcommerce().setEcommerceScreen(
            ...
            Objects.requireNonNull(Psa.getDefaultTracker()).getGlobalContexts().add("ruleSetExampleTag", gc);
            ...
            Psa.getDefaultTracker().getEmitter().setRequestCallback(getRequestCallback());
    ...
    private boolean setupWithLocalConfig() {
        ...
        Psa.createTracker(getApplicationContext(),
                namespace,
        ...
        Psa.subscribeToWebViewEvents(_webView);
        Objects.requireNonNull(Psa.getDefaultTracker()).getEcommerce().setEcommerceUser(
        ...
        Objects.requireNonNull(Psa.getDefaultTracker()).getGlobalContexts().add("global", staticGlobalContext);
