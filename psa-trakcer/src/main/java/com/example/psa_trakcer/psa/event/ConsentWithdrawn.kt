...
class ConsentWithdrawn(all: Boolean, documentId: String, documentVersion: String) :
    ...
    override val dataPayload: Map<String, Any?>
        get() {
            ...
            payload[com.example.psa_trakcer.core.constants.Parameters.CW_ALL] = all
            return payload
        }

    /** The event schema */
    override val schema: String
        get() = com.example.psa_trakcer.core.constants.TrackerConstants.SCHEMA_CONSENT_WITHDRAWN
