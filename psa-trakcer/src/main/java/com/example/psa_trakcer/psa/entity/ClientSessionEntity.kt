...
package com.example.psa_trakcer.psa.entity
...
class ClientSessionEntity(private val values: Map<String, Any?>) :
    SelfDescribingJson(com.example.psa_trakcer.core.constants.TrackerConstants.SESSION_SCHEMA, values) {

    val userId: String?
        get() = values[com.example.psa_trakcer.core.constants.Parameters.SESSION_USER_ID] as String?
}
