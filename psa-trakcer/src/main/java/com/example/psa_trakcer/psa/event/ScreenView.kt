...
class ScreenView @JvmOverloads constructor(name: String, screenId: UUID? = null) :
    ...
    override val dataPayload: Map<String, Any?>
        get() {
            ...
            payload[com.example.psa_trakcer.core.constants.Parameters.SV_ID] = id
            payload[com.example.psa_trakcer.core.constants.Parameters.SV_NAME] = name
            type?.let { payload[com.example.psa_trakcer.core.constants.Parameters.SV_TYPE] = it }
            previousId?.let { payload[com.example.psa_trakcer.core.constants.Parameters.SV_PREVIOUS_ID] = it }
            previousName?.let { payload[com.example.psa_trakcer.core.constants.Parameters.SV_PREVIOUS_NAME] = it }
            previousType?.let { payload[com.example.psa_trakcer.core.constants.Parameters.SV_PREVIOUS_TYPE] = it }
            transitionType?.let { payload[com.example.psa_trakcer.core.constants.Parameters.SV_TRANSITION_TYPE] = it }
            return payload
        }
    
    override val schema: String
        get() = com.example.psa_trakcer.core.constants.TrackerConstants.SCHEMA_SCREEN_VIEW
