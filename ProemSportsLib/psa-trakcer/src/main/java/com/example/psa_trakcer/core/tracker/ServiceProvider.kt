...
import com.example.psa_trakcer.core.emitter.*
...
import com.example.psa_trakcer.core.media.controller.MediaControllerImpl
import com.example.psa_trakcer.core.session.SessionControllerImpl
import com.example.psa_trakcer.psa.configuration.*
...
class ServiceProvider(
    ...
    private var emitter: com.example.psa_trakcer.core.emitter.Emitter? = null
    ...
    override val ecommerceController: com.example.psa_trakcer.core.ecommerce.EcommerceControllerImpl by lazy {
        com.example.psa_trakcer.core.ecommerce.EcommerceControllerImpl(this)
    }
    ...
    override fun getOrMakeEmitter(): com.example.psa_trakcer.core.emitter.Emitter {
    ...
    private fun makeEmitter(): com.example.psa_trakcer.core.emitter.Emitter {
        val endpoint = networkConfiguration.endpoint ?: ""
        
        val builder = { emitter: com.example.psa_trakcer.core.emitter.Emitter ->
        ...
        val emitter = com.example.psa_trakcer.core.emitter.Emitter(
            namespace = namespace,
