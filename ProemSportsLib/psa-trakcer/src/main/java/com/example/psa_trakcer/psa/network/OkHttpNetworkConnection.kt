...
import com.example.psa_trakcer.core.emitter.TLSArguments
import com.example.psa_trakcer.core.emitter.TLSVersion
...
class OkHttpNetworkConnection private constructor(builder: OkHttpNetworkConnectionBuilder) :
    ...
    private val JSON = com.example.psa_trakcer.core.constants.TrackerConstants.POST_CONTENT_TYPE.toMediaTypeOrNull()
    ...
    class OkHttpNetworkConnectionBuilder(
         ...
         * [Psa](com.psaanalytics.psa.Psa) interface, to configure tlsVersions.
        ...
        /**
         * An OkHttp cookie jar to override the default [CollectorCookieJar](com.psaanalytics.psa.network.CollectorCookieJar) that stores
    ...
    init {
        ...
        if (httpMethod == HttpMethod.GET) {
            ...
            uriBuilder.appendEncodedPath(
                com.example.psa_trakcer.core.constants.TrackerConstants.PROTOCOL_VENDOR + "/" +
                        com.example.psa_trakcer.core.constants.TrackerConstants.PROTOCOL_VERSION
            )
        } else {
