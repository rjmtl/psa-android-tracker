...
class TrackerError (
    ...
    override val dataPayload: Map<String, Any?>
        get() {
            ...
            payload[com.example.psa_trakcer.core.constants.Parameters.DIAGNOSTIC_ERROR_CLASS_NAME] = source
            payload[com.example.psa_trakcer.core.constants.Parameters.DIAGNOSTIC_ERROR_MESSAGE] = msg
            ...
            if (throwable != null) {
                ...
                payload[com.example.psa_trakcer.core.constants.Parameters.DIAGNOSTIC_ERROR_STACK] = stack
                payload[com.example.psa_trakcer.core.constants.Parameters.DIAGNOSTIC_ERROR_EXCEPTION_NAME] = throwableName
            }
            return payload
        }
    
    override val schema: String
        get() = com.example.psa_trakcer.core.constants.TrackerConstants.SCHEMA_DIAGNOSTIC_ERROR
