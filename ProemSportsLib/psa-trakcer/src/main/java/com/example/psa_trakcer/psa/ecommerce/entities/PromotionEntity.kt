...
data class PromotionEntity @JvmOverloads constructor(
    ...
    internal val entity: SelfDescribingJson
        get() = SelfDescribingJson(
            com.example.psa_trakcer.core.constants.TrackerConstants.SCHEMA_ECOMMERCE_PROMOTION,
            mapOf(
                com.example.psa_trakcer.core.constants.Parameters.ECOMM_PROMO_ID to id,
                com.example.psa_trakcer.core.constants.Parameters.ECOMM_PROMO_NAME to name,
                com.example.psa_trakcer.core.constants.Parameters.ECOMM_PROMO_PRODUCT_IDS to productIds,
                com.example.psa_trakcer.core.constants.Parameters.ECOMM_PROMO_POSITION to position,
                com.example.psa_trakcer.core.constants.Parameters.ECOMM_PROMO_CREATIVE_ID to creativeId,
                com.example.psa_trakcer.core.constants.Parameters.ECOMM_PROMO_TYPE to type,
                com.example.psa_trakcer.core.constants.Parameters.ECOMM_PROMO_SLOT to slot
