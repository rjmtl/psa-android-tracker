 ...
 */
package com.example.psa_trakcer.core.globalcontexts
...
import com.example.psa_trakcer.psa.globalcontexts.GlobalContext

@RestrictTo(RestrictTo.Scope.LIBRARY)
class GlobalContextsControllerImpl(serviceProvider: ServiceProviderInterface) :
    com.example.psa_trakcer.core.Controller(serviceProvider), GlobalContextsController {
