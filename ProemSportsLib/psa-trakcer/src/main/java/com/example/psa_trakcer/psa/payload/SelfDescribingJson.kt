 ...
 */
package com.example.psa_trakcer.psa.payload
...
open class SelfDescribingJson {
    ...
    fun setSchema(schema: String): SelfDescribingJson {
        ...
        payload[com.example.psa_trakcer.core.constants.Parameters.SCHEMA] = schema
        return this
    }
    ...
    fun setData(trackerPayload: TrackerPayload?): SelfDescribingJson {
        trackerPayload?.let { payload[com.example.psa_trakcer.core.constants.Parameters.DATA] = it.map }
        return this
    }
    ...
    fun setData(data: Any?): SelfDescribingJson {
        data?.let { payload[com.example.psa_trakcer.core.constants.Parameters.DATA] = it }
        return this
    }
    ...
    fun setData(selfDescribingJson: SelfDescribingJson?): SelfDescribingJson {
        selfDescribingJson?.let { payload[com.example.psa_trakcer.core.constants.Parameters.DATA] = it.map }
        return this
    }
