...
import com.example.psa_trakcer.core.utils.Util.uUIDString
...
class ScreenState(
    ...
    fun getCurrentScreen(debug: Boolean): SelfDescribingJson {
        ...
        contextPayload.add(com.example.psa_trakcer.core.constants.Parameters.SCREEN_ID, id)
        contextPayload.add(com.example.psa_trakcer.core.constants.Parameters.SCREEN_NAME, name)
        contextPayload.add(com.example.psa_trakcer.core.constants.Parameters.SCREEN_TYPE, type)
        if (debug) {
            contextPayload.add(
                com.example.psa_trakcer.core.constants.Parameters.SCREEN_FRAGMENT,
                getValidName(fragmentClassName, fragmentTag)
            )
            contextPayload.add(
                com.example.psa_trakcer.core.constants.Parameters.SCREEN_ACTIVITY,
                getValidName(activityClassName, activityTag)
            )
        }
        return SelfDescribingJson(
            com.example.psa_trakcer.core.constants.TrackerConstants.SCHEMA_SCREEN,
            contextPayload
        )
    }
