...
class SelfDescribing : AbstractSelfDescribing {
    ...
    constructor(eventData: SelfDescribingJson) {
        ...
        val payload = eventDataMap[com.example.psa_trakcer.core.constants.Parameters.DATA] as Map<String, Any?>
        dataPayload = payload 
        
        val schema = eventDataMap[com.example.psa_trakcer.core.constants.Parameters.SCHEMA] as String
        this.schema = schema
