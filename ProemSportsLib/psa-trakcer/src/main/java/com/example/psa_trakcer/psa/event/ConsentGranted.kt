...
class ConsentGranted(expiry: String, documentId: String, documentVersion: String) :
    ...
    override val dataPayload: Map<String, Any?>
        get() {
            ...
            payload[com.example.psa_trakcer.core.constants.Parameters.CG_EXPIRY] = expiry
            return payload
        }

    /** The event schema */
    override val schema: String
        get() = com.example.psa_trakcer.core.constants.TrackerConstants.SCHEMA_CONSENT_GRANTED
